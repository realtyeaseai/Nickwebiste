// src/components/shared/HeroBand.tsx
...
export default function HeroBand({ eyebrow, title, accentWord, subtitle }: HeroBandProps) {
  ...
  return (
    <section className="bg-gradient-to-br from-[#1B3FA0] to-[#0f2260] py-14 px-4 sm:px-10 relative overflow-hidden">
      <div className="absolute right-0 top-0 w-64 h-64 border-2 border-white/5 rounded-full -translate-y-1/2 translate-x-1/2" />
      <div className="absolute right-16 top-1/2 w-40 h-40 border border-white/[0.03] rounded-full -translate-y-1/2" />
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="w-14 h-1 bg-[#93c5fd] rounded mb-4" />
